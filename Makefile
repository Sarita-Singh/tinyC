test: parser.out libmyl.a
	...
	./parser.out testFiles/ass6_20CS10020_20CS10053_test5.c assemblyFiles/ass6_20CS10020_20CS10053_test5.s > quadsOutput/ass6_20CS10020_20CS10053_quads5.out
	@echo "\nCompiling assembly files\n"
	gcc assemblyFiles/ass6_20CS10020_20CS10053_test1.s -L. -lmyl -no-pie -o test1
	gcc assemblyFiles/ass6_20CS10020_20CS10053_test2.s -L. -lmyl -no-pie -o test2
	gcc assemblyFiles/ass6_20CS10020_20CS10053_test3.s -L. -lmyl -no-pie -o test3
	# gcc assemblyFiles/ass6_20CS10020_20CS10053_test4.s -L. -lmyl -no-pie -o test4
	gcc assemblyFiles/ass6_20CS10020_20CS10053_test5.s -L. -lmyl -no-pie -o test5
...
clean:
	...
	rm libmyl.a myl.o parser.out ass6_20CS10020_20CS10053_translator.o ass6_20CS10020_20CS10053_target_translator.o lex.yy.* y.tab.* y.output assemblyFiles/*.s quadsOutput/*.out test? outputFiles/*.txt
